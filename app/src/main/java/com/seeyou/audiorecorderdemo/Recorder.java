...
package com.seeyou.audiorecorderdemo;
...
public class Recorder implements OnCompletionListener, OnErrorListener {
    ...
    public void startRecording(int outputfileformat, String extension, Context context) {
        ...
        if (mSampleFile == null) {
            File sampleDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS);
        ...
        try {
            ...
            boolean isInCall = ((audioMngr.getMode() == AudioManager.MODE_IN_CALL) || (audioMngr.getMode() == AudioManager.MODE_IN_COMMUNICATION));
            if (isInCall) {
